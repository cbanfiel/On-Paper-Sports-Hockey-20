...
export default class ListItem extends React.Component {
    ...
    render() {
        return(
            ...
            <Text style={[{ fontFamily: 'advent-pro', fontSize:16 }, this.props.rightTitleStyle]} >{this.props.rightTitle}</Text>
                <Text style={[{ fontFamily: 'advent-pro' , fontSize:14 }, this.props.rightSubtitleStyle]} >{this.props.rightSubtitle}</Text>
            </View>
            {
